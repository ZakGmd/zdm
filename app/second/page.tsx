...
export default function Second(){
    ...
    return(
      ...
      <div className="flex items-center justify-between pt-[174px] pr-[295px] pl-[132px] ">
        <div className="flex flex-col items-start gap-[44px]">
          ...
          <div className="flex items-center gap-[16px]">
            <Link href={""} className="flex justify-center items-center gap-[10px] rounded-[56px] py-[10px] px-4 bg-gradient-to-b from-[#663ade] from-[-41.25%] to-[#2E1C62] hover:from-[#2E1C62] transition-all duration-300  text-white text-[14px] font-medium leading-[20px] tracking-[-0.28px] ">Hire Ava</Link>
            <Link href={""} className="flex justify-center items-center gap-[10px] rounded-[56px] py-[10px] px-4 bg-gradient-to-b from-[#99999937] from-[-41.25%]  via-[#bdbdbd1a] via-30% to-[#ffffff1a] hover:bg-[#bdbdbd1a] transition-colors  duration-300  text-white text-[14px] font-medium leading-[20px] tracking-[-0.28px] ">Meet all artisans</Link>
          </div>
        </div>
      ...
      <div className="w-full flex items-center mt-[100px] justify-center">
        <div className="flex flex-col  items-center max-w-[600px] gap-10 mt-6">
